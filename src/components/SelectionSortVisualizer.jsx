...
const SelectionSortVisualizer = () => {
    ...
    const resetState = (newArray = array) => {
        ...
        setAnimationStates({}); // Reset animation states
        ...
        for (let i = 0; i < n - 1; i++) {
            ...
            if (minIdx !== i) {
                ...
                setAnimationStates(prevState => ({
                    ...prevState,
                    [i]: { ...arr[minIdx], translate: (minIdx - i) * 50 },
                    [minIdx]: { ...arr[i], translate: (i - minIdx) * 50 },
                }));
                await sleep(speed);
                    ...
                    {array.map((value, idx) => (
                        <div
                            ...
                            style={{
                                width: '40px',
                                height: `${value * 3}px`,
                                transform: animationStates[idx] ? `translateX(${animationStates[idx].translate}px)` : 'translateX(0px)',
